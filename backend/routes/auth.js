...
router.post(
  "/revokedData",
  authentication.authenticateUser,
  authController.fetchRevokedData
);
router.post(
  "/usageData",
  authentication.authenticateUser,
  authController.fetchUsageData
);
router.post(
  "/logs",
  authentication.authenticateUser,
  authController.fetchLogsData
);
router.get(
  "/dashboard",
  authentication.authenticateUser,
...
router.get(
  "/userSessionInfo",
  authentication.authenticateUser,
  authController.userSessionInfo
);
router.post(
  "/certificateUpload",
  authentication.authenticateUser,
  authController.certificateUpload
);
router.post(
  "/extractCert",
  authentication.authenticateUser,
  authController.extractCert
);
router.post(
  "/updatePassword",
  authentication.authenticateUser,
...
router.post(
  "/authorities",
  authentication.authenticateUser,
  authController.authorities
);
router.post(
  "/organizations",
  authentication.authenticateUser,
  authController.organizations
);
router.post(
  "/orgList",
  authentication.authenticateUser,
  authController.organizationList
);
router.post(
  "/usageOptions",
  authentication.authenticateUser,
  authController.usageOptions
);
...
router.post(
  "/updateAuths",
  authentication.authenticateUser,
  authController.updateAuths
);
router.post(
  "/getSubType",
  authentication.authenticateUser,
  authController.getSubType
);
...
router.post(
  "/getStatesByRegion",
  authentication.authenticateUser,
  authController.getStatesByRegion
);
...
router.post(
  "/addRegion",
  authentication.authenticateAdmin,
  authController.addRegion
);
router.post(
  "/updateStatesOfRegion",
  authentication.authenticateAdmin,
  authController.updateStatesOfRegion
);
router.post(
  "/moveStatesOfRegion",
  authentication.authenticateAdmin,
  authController.moveStatesOfRegion
);
router.post(
  "/removeRegion",
  authentication.authenticateAdmin,
  authController.removeRegion
);
...
router.post(
  "/report",
  authentication.authenticateUser,
  authController.reportGenerator
);
router.post(
  "/statusCheck",
  authentication.authenticateUser,
  authController.statusCheck
);
...
router.post(
  "/blockchain/verify",
  authentication.authenticateUser,
  blockchainController.verifyCertificiate
);
router.post(
  "/blockchain/issuedCertiifcates",
  authentication.authenticateUser,
  blockchainController.getBlockchainData
);
